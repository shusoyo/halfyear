...
== 极值、最值、单调性、拐点、凹凸性、渐近线
#definition("极值、单调性、拐点、凹凸性")[
  《高等数学辅导讲义》P66.

  #annotation()[
    #hl()[极值与最值在《张宇 30 讲》中，均取 $=$ 号.]
  ]
]

#annotation()[
  + 判断极值与拐点的第一充分条件均是在 #hl[_去心临域_] 内可导。
...
#proposition("渐近线的定义")[如果
  $f (x) = a x + b + alpha (x) ,$ 这里 $a eq.not 0$,
  $lim_(x arrow.r oo) alpha (x) = 0$. 则曲线 $y = f (x)$ 有斜渐近线
  $y = a x + b$.
]
